...
//            printf( "client disconnect\n" );
    ...
    void Client::UpdateNetworkSimulator()
    {
        ...
        // todo: it's inconsistent that this is updated here, compared with the network interface which must be updated elsewhere
        // this should probably be moved externally
