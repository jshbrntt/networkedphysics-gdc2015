...
namespace cubes
{
    ...
    void DecompressOrientation(uint32_t compressed_orientation, math::Quaternion &orientation)
    {
        ...
        case 0:
        {
            ...
            orientation.z = b;
            orientation.w = c;
            orientation.x = math::sqrt(1 - orientation.y * orientation.y - orientation.z * orientation.z - orientation.w * orientation.w);
        }
        break;
        ...
        case 1:
        {
            ...
            orientation.z = b;
            orientation.w = c;
            orientation.y = math::sqrt(1 - orientation.x * orientation.x - orientation.z * orientation.z - orientation.w * orientation.w);
        }
        break;
        ...
        case 2:
        {
            ...
            orientation.y = b;
            orientation.w = c;
            orientation.z = math::sqrt(1 - orientation.x * orientation.x - orientation.y * orientation.y - orientation.w * orientation.w);
        }
        break;
        ...
        case 3:
        {
            ...
            orientation.y = b;
            orientation.z = c;
            orientation.w = math::sqrt(1 - orientation.x * orientation.x - orientation.y * orientation.y - orientation.z * orientation.z);
        }
        break;
